...
const roleColors = {
  ...
  const renderLogsTable = () => {
    ...
    if (filteredLogs.length === 0)
      return <p className="text-center text-black py-8">No activity logs found.</p>;

    return (
      <div className="overflow-x-auto ">
        <table className="min-w-full divide-y divide-border">
          <thead className="bg-[#FA8112] text-foreground/90">
            <tr>
              <th
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <h1 className="text-3xl font-bold text-[#222222] flex items-center gap-3">
        ...
        <div className="flex gap-3 w-full sm:w-auto flex-wrap sm:flex-nowrap">
          ...
          <button
            ...
            className="bg-[#FA8112] text-white px-3 py-2 rounded-md flex items-center gap-2 hover:bg-[#FAF3E1] hover:text-[#222222]  border-[#F5E7C6] border-2 hover:border-[#FA8112] "
          >
      ...
      <Card className="p-0 bg-[#37353E]">
        ...
        <div className="p-6 bg-white">{renderLogsTable()}</div>
      </Card>
    </div>
  );
};
