...
//                     </div>
//                     <div>
//                         <span className="text-2xl font-bold" style={{ color: item.color === 'blue' ? '#0A4D8C' : item.color === 'red' ? '#D90429' : '#6C757D' }}>{item.category}</span>
//                         <p className="text-lg text-muted-foreground font-semibold">{item.date}</p>
//                     </div>
//                 </div>
//                 <h3 className="text-2xl font-bold text-foreground mb-3">{item.title}</h3>
//                 <p className="text-xl text-muted-foreground flex-grow">{item.summary}</p>
//             </div>
//             <motion.div
...
//                 <p className="text-xl text-muted-foreground flex-grow">{item.details}</p>
...
//   return (
//     <section className="py-20 bg-yellow-100 text-gray-900">
//       <div className="max-w-7xl mx-auto text-center">
//         <motion.h2
//           className="text-5xl md:text-5xl font-extrabold mb-12"
